...
export function ScriptButton({
  ...
  return (
    <Button
      ...
      className={`relative inline-flex items-center justify-center border ${activeScript === script
