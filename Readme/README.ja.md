...
- 2.2.0 (2025-3-14)
  - 東南アジアの主要な非ラテン文字言語（タイ語、ミャンマー語、カンボジア語、ラオス語）および一部のラテン文字言語（ベトナム語）のサポートを追加
  - <ruby>タグを使用して、ローマ字注釈のタグとスタイルを最適化
  - 現在、言語オプションパネルはページの言語に基づいて自動的に対応するグループを展開します

- 2.3.0 (2025-3-21)
  - アラビア文字のサポートを追加（アラビア語、ペルシャ語、ウルドゥー語）
  - 地中海地域の言語サポートを追加（ギリシャ語、ヘブライ語、ベルベル語）
  - コーカサス地域の言語サポートを追加（グルジア語、アルメニア語）
  - 一部の言語注釈の表示不具合を修正
